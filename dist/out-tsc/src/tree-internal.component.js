...
var TreeInternalComponent = (function() {
  ...
  TreeInternalComponent.prototype.ngOnInit = function() {
    ...
    this.isReadOnly =
      !fn_utils_1.get(this.settings, 'enableCheckboxes', true) &&
      !fn_utils_1.get(this.settings, 'checkedIsVisible', true);
    if (this.tree.isRoot() && this.settings.rootIsVisible === false) {
      this.tree.disableCollapseOnInit();
    }
    this.subscriptions.push(
      this.nodeMenuService.hideMenuStream(this.nodeElementRef).subscribe(function() {
    ...
    this.subscriptions.push(
      this.treeService.draggedStream(this.tree, this.nodeElementRef).subscribe(function(e) {
  ...
  TreeInternalComponent.prototype.applyNewValue = function(e) {
    if (
      (e.action === editable_events_1.NodeEditableEventAction.Cancel || this.tree.isNew()) &&
  ...
  __decorate([core_1.Input(), __metadata('design:type', tree_1.Tree)], TreeInternalComponent.prototype, 'tree', void 0);
  __decorate(
    [core_1.Input(), __metadata('design:type', TreeTypes.Ng2TreeSettings)],
    TreeInternalComponent.prototype,
    'settings',
    void 0
  );
  __decorate(
    [core_1.Input(), __metadata('design:type', core_1.TemplateRef)],
    TreeInternalComponent.prototype,
    'template',
    void 0
  );
